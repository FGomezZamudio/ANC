...
class FormularioRegistroVisitas(tk.Toplevel): 
    ...
    def controles_barra_superior(self):
        ...
        self.labeltitulo = tk.Label (self.barra_superior, text = "Registro de visitas")
    ...
    def controles_menu_lateral(self):
        ...
        self.boton_añadir_visita = tk.Button(self.menu_lateral) # command tiene que llamar a la función correspondiente del back que es añadir pacientes
        self.boton_editar_registro = tk.Button(self.menu_lateral)
        self.boton_visualizar_historial = tk.Button(self.menu_lateral)
        ...
        buttons_info = [
            ("Añadir visita", "\uf133", self.boton_añadir_visita),
            ("Editar registro", "\uf044", self.boton_editar_registro),
            ("Visualizar historial","\uf06e", self.boton_visualizar_historial),
            ]
